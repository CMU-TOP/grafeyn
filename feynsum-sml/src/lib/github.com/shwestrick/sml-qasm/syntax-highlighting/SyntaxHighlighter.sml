...
struct
  ...
  fun tokColor class =
    case class of
      Token.StringLiteral => TCS.foreground red
    (* | Token.CharConstant => TCS.foreground purple *)
    (* | Token.WordConstant => TCS.foreground yellow *)
    | Token.LineComment => TCS.italic o TCS.foreground gray
    | Token.BlockComment => TCS.italic o TCS.foreground gray
    | Token.DecimalIntegerLiteral => TCS.foreground lightblue
    ...
    | _ => raise Fail ("Uh oh: tokColor " ^ Token.classToString class)
